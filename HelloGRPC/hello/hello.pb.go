...
func (c *greeterClient) SayHelloAgain(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := grpc.Invoke(ctx, "/hello.Greeter/SayHelloAgain", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	0x35, 0xaa, 0xe2, 0x62, 0x77, 0x2f, 0x4a, 0x4d, 0x2d, 0x49, 0x2d, 0x12, 0x32, 0xe1, 0xe2, 0x08,
	0x4e, 0xac, 0x04, 0xeb, 0x12, 0x12, 0xd6, 0x83, 0xd8, 0x8b, 0x6c, 0x8f, 0x94, 0x20, 0xaa, 0x60,
	0x41, 0x4e, 0xa5, 0x12, 0x83, 0x90, 0x25, 0x17, 0x2f, 0x4c, 0x97, 0x63, 0x7a, 0x62, 0x66, 0x1e,
	0xf1, 0x5a, 0x93, 0xd8, 0xc0, 0xbe, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x52, 0xfc, 0xaa,
	0x30, 0xe4, 0x00, 0x00, 0x00,
}
